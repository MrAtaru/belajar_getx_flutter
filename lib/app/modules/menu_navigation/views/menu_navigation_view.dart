...
class MenuNavigationView extends StatefulWidget {
  const MenuNavigationView({super.key});

  @override
  State<MenuNavigationView> createState() => _MenuNavigationState();
}

class _MenuNavigationState extends State<MenuNavigationView> {
  // @override
  int _selectedTab = 0;
